...
set_random()
seeds = random.sample(range(10000000), 100000)
...
if args.universal:
    ...
    if "refined_V" in args.universal_options:
        V = torch.load(data_prefix + args.dataset + '/word_vec_trg_tensor_refined.pt')
    else:
...
while True:
    ...
    if iters % args.eval_every == 0:
        ...
        for j in range(args.valid_epochs):
            ...
            fast_weights = inner_loop(args, (train_real, "ro"), model, fast_weights, dev_iters, inner_steps=args.valid_steps, self_opt=self_opt)
