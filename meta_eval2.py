...
train_real, dev_real, test_real = data.BucketIterator.splits(
    (train_data, dev_data, test_data), batch_sizes=(args.batch_size, args.batch_size, args.batch_size), device=args.gpu, shuffle=True,
...
valid_model(args, model, test_real, print_out=True, beam=4)
